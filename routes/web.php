...
//TIENES QUE IMPORTAR TODOS LOS CONTROLADORES DE LAS VISTAS ESTO ES FEO :V
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->middleware('is_admin')->group(function () {
        ...
        // RUTAS PARA LOS LEGAJOS OH SEÑOR CHAT GPT PROTEGEME
        ...
        Route::get('/admin/legajo/actualizar', [LegajoController::class, 'showUpdateForm'])->name('legajo.update.form');
        Route::post('/admin/legajo/buscar', [LegajoController::class, 'buscarUsuarioParaActualizar'])->name('legajo.buscar.update');
        Route::post('/admin/legajo/actualizar', [LegajoController::class, 'actualizarLegajo'])->name('legajo.update');

        // rutas buscar y filtrar(?)
        Route::get('/admin/usuarios/buscar', [LegajoController::class, 'mostrarBusqueda'])->name('usuarios.buscar');
        Route::post('/admin/usuarios/buscar', [LegajoController::class, 'buscarUsuarios'])->name('usuarios.buscar.submit');
    ...
    Route::put('/user/legajo/{legajo}', [LegajoController::class, 'actualizarLegajo'])->name('legajo.update');
